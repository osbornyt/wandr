...
document.addEventListener('DOMContentLoaded', () => {
    const contentMain = document.getElementById('content-main'); // Get the container
    fetch(url + 'fetch_form_data/') // Replace 'your_json_file.json' with the actual path
        ...
        .catch(error => {
            ...
            contentMain.innerHTML = "<p>Error loading json configuration file.</p>"; // Display an error message
        });
});
...
function constructInfoPage(slide){
    ...
    contentMain.innerHTML = `<div class="form-container ${slide}">
...
function construct_last_page(){
    ...
    contentMain.innerHTML = `<div class="form-container slide-left">
            <div class="main-info">
                <h2>Completed !!</h2>
...
function construct_page(page_num, slide){
    ...
    let formHTML = `<form id="myForm"><div class="${slide} form-container"> <h2>Section ${page_num}</h2>`;
        ...
        contentMain.innerHTML = formHTML;

...
from .views import generate_evaluation_auto,delete_Evaluation,preview_evaluation,agreements
from .views import upload_contract, delete_contract,agreement_entry,resource
...
urlpatterns = [
    ...
    path('delete_contract/<int:form_id>/', delete_contract, name="delete_contract"),
    path('agreement_entry/', agreement_entry, name="agreement_entry"),
